...
var _cartBtn = require("./js/cartBtn");
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
//MAIN SCRIPTS
var _api = require("./js/api");
var _apiDefault = parcelHelpers.interopDefault(_api);
var _renderProducts = require("./js/renderProducts");
var _renderProductsDefault = parcelHelpers.interopDefault(_renderProducts);
const listEl = document.querySelector("[data-product-list]");
async function getNewProducts() {
    const res = await (0, _apiDefault.default)();
    return renderIfNotEmpty(res);
}
getNewProducts();
function renderIfNotEmpty(products) {
    if (products.length > 0) listEl.insertAdjacentHTML("beforeend", (0, _renderProductsDefault.default).reduceProductsArrToMarkup(products));
}

},{"./js/cartBtn":"isAvi","axios":"jo6P5","./js/api":"9u7qN","./js/renderProducts":"iY7ma","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"isAvi":[function(require,module,exports) {
(()=>{
    const refs = {
...
parcelHelpers.export(exports, "getPage", ()=>getPage);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
const BASEURL = `https://voodoo-sandbox.myshopify.com/products.json?limit=24`;
let page = 1;
async function getProducts() {
    const res = await (0, _axiosDefault.default).get(`${BASEURL}&page=${page}`);
    return res.data.products;
}
const getPage = ()=>page;

},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"iY7ma":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
function makeProductMarkup({ title, price_min, images }) {
    return `<li class="inline-block md:w-2/5 lg:w-[300px]">
        ...
        <div class="flex flex-row justify-between" style="margin-top:10px">
            <p class="inline-block font-SpaceGrotesk text-black font-bold text-sm">${title ? title : "Product name"}<br>${price_min ? price_min : "000"} KR.</p>
...
function reduceProductsArrToMarkup(products) {
    return products.reduce((markup, product)=>makeProductMarkup(product) + markup, "");
}
exports.default = {
    makeProductMarkup,
